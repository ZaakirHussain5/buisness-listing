              ...
              if (!b || !b.requirejs) {
                  ...
                  !(function (b) {
                      ...
                      function f(a, b) {
                          ...
                          if ((o || q) && p) {
                              for (c = a.split("https://themezhub.net/"), k = c.length; k > 0; k -= 1) {
                                  if (((d = c.slice(0, k).join("https://themezhub.net/")), o))
                                      for (l = o.length; l > 0; l -= 1)
                                          if ((e = p[o.slice(0, l).join("https://themezhub.net/")]) && (e = e[d])) {
                                              (f = e), (h = k);
                                              break;
                                          }
                                  if (f) break;
                              ...
                              !f && i && ((f = i), (h = j)), f && (c.splice(0, h, f), (a = c.join("https://themezhub.net/")));
                          }
                          return a;
                      }
                      function g(a, c) {
